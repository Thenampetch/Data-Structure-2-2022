...
public class BST {
	...
	public void addLeftSubTreeToMin(BST subtree) {
		...
		//if tree is empty subtree is tree.
		if (root == null) {
			root = subtree.root;
			size = subtree.size;
			return;
		}
		//insert subtree to the leftmost.
		//find max node of subtree.
		BSTNode maxsubtree = ((TreeIterator) subtree.findMax()).currentNode;
		//find leftmost of tree.
		BSTNode leftmost = ((TreeIterator) this.findMin()).currentNode;
		//check BST validation.
		if (leftmost.data > maxsubtree.data) {
			leftmost.left = subtree.root;
			size += subtree.size;
		}
		return;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		BSTNode r = new BSTNode(9);
		BST t = new BST(r, 1);
		
		BSTNode k = new BSTNode(6);
		BST t1 = new BST(k,1);
		//t.insert(9);
		t.insert(7);
		t.insert(11);
